...
Total explanatory modeled value units.

- Expression: `SUM(modeled_value_units)`
- Synonyms: 가상 가치 단위, Synthetic Value

### Modeled Efficiency

Modeled value units per simulated spend unit; yields NULL when spend is zero.
...
Simulated spend units per engagement; yields NULL when engagements are zero.
...
Ratio of engagements to impressions; yields NULL when impressions are zero.
