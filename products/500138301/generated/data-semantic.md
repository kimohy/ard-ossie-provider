...
Simulation spend units per engagement; returns NULL when total engagements are zero.
...
Ratio of engagements to impressions; returns NULL when total impressions are zero.

- Expression: `SUM(marketing_delivery.engagement_count) / NULLIF(SUM(marketing_delivery.impression_count), 0)`
- Synonyms: 반응률

### Modeled Value Units

Total modeled value units.
